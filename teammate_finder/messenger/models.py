...
class Chats(models.Model):
    user1_id = models.ForeignKey(Users, on_delete=models.CASCADE, null=True, verbose_name='Участник_1',
                                 related_name='chat_member1')
    user2_id = models.ForeignKey(Users, on_delete=models.CASCADE, null=True, verbose_name='Участник_2',
...
class Messages(models.Model):
    ...
    sender_id = models.ForeignKey(Users, on_delete=models.CASCADE, null=True, verbose_name='id_отправителя')
